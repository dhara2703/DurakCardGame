...
namespace DurakUI
{
    public partial class frmPlayTime : MyForm
    {
        ...
        public frmPlayTime()
        {
            ...
            table = new Table(GameMode.Durak);  // Creates a table object for the Durak game
            ...
            pbDeck.Image = pictureColor;     // A new card will be created with face down, so the Deck will have the back image
            pbDiscard.Image = null; ;     // Start with no image
            ...
            lblComputerName.Text = Player.RandomName(4);
